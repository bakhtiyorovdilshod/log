...
async def retrieve_rabbit_consumer():
    """for rabbit consumer data with validation"""
    rabbit_list = []
    async for item in db.db['rabbit_consumer'].find():
        rabbit_list.append(rabbit_consumer_helper(item))
    return rabbit_list
